...
public class PlanterScreen extends Screen {

    private static final int W = 200, H = 130;
    private final BlockPos pos;
    private int range;
    private int plantedLast;
    private int x, y;
    ...
    public void updateStatus(int range, int plantedLast) {
        this.range = range;
    ...
    private void setRange(int r) {
        ...
        ClientPlayNetworking.send(new SetMachineRangePayload(pos, range, false));
    }
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        han.hanstudio.precisionAgriculture.client.gui.AgriGuiUtils.drawTitleBar(ctx, x, y, W,
            han.hanstudio.precisionAgriculture.client.gui.AgriGuiTextures.TITLE_BAR_PLANTER);
        ...
        ctx.drawCenteredTextWithShadow(textRenderer, Text.literal("最近播种: " + plantedLast + " 株"), x + W / 2, y + 88, plantedLast > 0 ? 0xFF008000 : 0xFF666666);
        ctx.drawCenteredTextWithShadow(textRenderer, Text.literal(plantedLast > 0 ? "状态: 工作中" : "状态: 待命中"), x + W / 2, y + 102, plantedLast > 0 ? 0xFF008000 : 0xFF888888);
