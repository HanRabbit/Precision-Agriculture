...
public class HarvesterHandledScreen extends HandledScreen<HarvesterScreenHandler> {

    public HarvesterHandledScreen(HarvesterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        // 绘制标题栏
        AgriGuiUtils.drawTitleBar(context, x, y, backgroundWidth, AgriGuiTextures.TITLE_BAR_HARVESTER);
